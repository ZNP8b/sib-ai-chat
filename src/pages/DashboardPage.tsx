...
const DashboardPage: React.FC = () => {
  return (
    <Layout>
      {/* Hero Section */}
      <div
        className="relative! bg-gradient-to-br from-purple-700 to-pink-500 text-white py-20! px-8! rounded-lg shadow-lg overflow-hidden!">
        <div
          className="absolute! inset-0! opacity-30 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-purple-500 to-pink-700"></div>
      ...
      <div className="mt-12! grid! grid-cols-1! md:grid-cols-3! gap-8!">
        <div className="bg-white p-6! rounded-lg! shadow-md! text-center!">
          <h2 className="text-2xl! font-bold! mb-4! text-purple-600">Датасеты</h2>
        ...
        <div className="bg-white p-6! rounded-lg! shadow-md text-center!">
          <h2 className="text-2xl! font-bold! mb-4 text-purple-600">Чекпоинты</h2>
          <p className="text-gray-600!">
